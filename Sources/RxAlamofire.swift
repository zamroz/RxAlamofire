...
extension Reactive where Base: Session {
   ...
   */
    func request<R: RxAlamofireRequest>(_ createRequest: @escaping (Session) throws -> R) -> Observable<R> where R: Request {
...
extension ObservableType where Element: DownloadRequest {
  ...
  public func response() -> Observable<AFDownloadResponse<URL?>> {
  ...
  public func responseSerialized<Serializer: DownloadResponseSerializerProtocol>(
    ...
    -> Observable<AFDownloadResponse<Serializer.SerializedObject>>
  {
